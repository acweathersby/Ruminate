...
namespace RUMINATE
{
    namespace STRING
    {
        ...
        typedef unsigned char idsite; // 256 Sites
        ...
        struct OP_ID {
            ...
            bool compareVectorClock(const OP_ID & other) const { return other.site == site && other.clock == clock; }
            ...
            friend bool operator==(const OP_ID & a, const OP_ID & b) { return a.clock == b.clock && a.site == b.site; }

            friend bool operator!=(const OP_ID & a, const OP_ID & b) { return !(b == a); }

            bool follows(const OP_ID & id) const { return id.site == site && id.clock == clock - 1; }
